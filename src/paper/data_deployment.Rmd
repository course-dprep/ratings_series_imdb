...
The aim of this study was to explore the relationship between TV show length and episode rating. A regression analysis, supported by a plot visualization (both can be found below), examined how runtime impacts viewer evaluations.
...
The result is statistically significant, with a p-value of 0, confirming that the relationship is unlikely to be due to chance. While the effect is small, longer runtimes do result in lower ratings. Both the regression analysis and plot visualization can be seen below.
...
#### Plot of relationship between TV show runtime and ratings
